...
public interface SpringXmlFileLocator
{
    ...
    /**
     * Finds all Spring XML files in a Maven project. Scans a project's resources and test resources for valid Spring
     * XML files. Resource excludes and includes apply.
     * 
     * @param project
