...
public class SpringProjectDependencyAnalyzerTest extends TestCase {
	...
	private static final class InputStreamMatcher implements IArgumentMatcher {

		private final String contents;

		private InputStreamMatcher(String contents) { this.contents = contents; }
	...
	public void testAnalyze() throws Exception {
		...
		// setup file locator
		final SpringXmlFileLocator fileLocator = 
			createMock( SpringXmlFileLocator.class );
		...
		// setup file parser
		final SpringXmlParser fileParser=
			createMock(SpringXmlParser.class);
	...
	public void testAnalyzeWithInvalidSpringXML() throws Exception {
